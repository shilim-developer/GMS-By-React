...
class RoleAddictionPage extends React.Component {
  ...
  render() {
    ...
    return (
      <QueueAnim duration="1200">
        <div key="roleAddiction" style={{padding: 15, background: '#fff'}}>
          <Breadcrumb>
...
RoleAddictionPage = Form.create()(RoleAddictionPage);

export default RoleAddictionPage
